/***************************************************************
 * File:        decr_path_top.sv
 * Module(s):   decr_path_top
 * Author:      Christopher Nokes, ChristopherRNokes@gmail.com
 * Description: Decryption path of an AES core, including FIFOs,
 ...
 *              i_reg_addr----------logic[3:0]------Register to address; reg space includes key, IV (unused in decryption), and configuration
...
module decr_path_top(i_clk, i_rst, i_write_fifo_en, i_data, i_reg_addr, i_reg_val, i_reg_write_en, i_read_next, o_data, o_reg_val);
  input logic i_clk;
  input logic i_rst;
  ...
  */
  ...
  decr_round_block_top decr_block_inst(.i_clk(i_clk),
